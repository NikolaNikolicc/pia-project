...
userRouter.route('/getAllOwners').post((req, res) => new user_controller_1.UserController().getAllOwners(req, res));
userRouter.route('/getAllDecorators').post((req, res) => new user_controller_1.UserController().getAllDecorators(req, res));
